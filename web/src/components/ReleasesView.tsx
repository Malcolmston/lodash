...
import { LODASH } from '../data';

// Scoped to this repository only: the live release history is read straight from
// the GitHub Releases API for malcolmston/lodash.
const RELEASE_LIBS: RelLib[] = [
  { name: LODASH.name, icon: LODASH.icon, accent: LODASH.accent, repo: ghrepo(LODASH), url: LODASH.repo },
];
