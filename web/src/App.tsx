...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/lodash', initials: 'ld', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/lodash</span> — type-safe, lodash-style functional utilities for Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · standard-library-only, inspired by lodash</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/lodash" footer={footer}>
